    ...
    def _create_model_tab(self):
        ...
        def check_hf_model(model_id, use_auth_token):
            try:
                ...
                info_text += f"❤️ Likes: {model_info.likes:,}\n"
                info_text += f"📅 Last Modified: {model_info.lastModified}\n"
                
                if model_info.pipeline_tag:
                    info_text += f"🏷️ Pipeline: {model_info.pipeline_tag}\n"
            ...
            with gr.Column():
                ...
                with gr.Group():
                    ...
                    with gr.Row():
                        ...
                        process_all_btn = gr.Button("⚙️ Process All")
                ...
                with gr.Group():
                    ...
                    view_file_btn = gr.Button("👁️ View File")
        ...
        with gr.Row():
            with gr.Column():
                ...
                with gr.Group():
                    ...
                    scrape_btn = gr.Button("🕷️ Scrape URLs", variant="primary")
